...
__all__ = [
    'SAFT22kHz16BitMono', 'SPXRO_SML', 'DISPID_SPRNumberOfElements',
    'SAFTCCITT_uLaw_11kHzMono', 'ISpDataKey',
    'DISPID_SRCEventInterests', 'DISPID_SRCRetainedAudio',
    'SpNullPhoneConverter', 'SpeechAddRemoveWord', 'SPWAVEFORMATTYPE',
    'SPCT_SUB_DICTATION', 'ISpeechVoice',
    'DISPID_SRGetPropertyString', 'SPINTERFERENCE_TOOFAST',
    'SPAS_CLOSED', 'SREStateChange', 'SpeechTokenKeyAttributes',
    'DISPID_SRCBookmark', 'DISPID_SPPs_NewEnum',
    ...
    'DISPID_SOTIsUISupported', 'DISPID_SLPs_NewEnum',
    'SECFIgnoreWidth', 'ISpeechObjectTokenCategory', 'SVF_Emphasis',
    'SPEI_REQUEST_UI', 'SpeechAudioProperties',
    'SPEI_SR_RETAINEDAUDIO', 'SAFT12kHz16BitMono', 'SPRS_INACTIVE',
    'DISPID_SpeechGrammarRuleState', 'DISPID_SRCESoundStart',
    'SAFTCCITT_uLaw_22kHzStereo', 'SpeechTokenShellFolder',
    'tagSPTEXTSELECTIONINFO', 'SWPUnknownWordPronounceable',
    'ISpPhraseAlt', 'SGRSTTTextBuffer', 'SAFT8kHz16BitStereo',
    'SRSEDone', 'DISPID_SRState', 'SAFTADPCM_8kHzStereo',
    'ISpPhoneticAlphabetConverter', 'DISPID_SVGetAudioOutputs',
    'eLEXTYPE_PRIVATE10', 'SAFT24kHz8BitMono', 'ISpeechPhraseRules',
    'DISPID_SpeechGrammarRuleStateTransition', 'SSSPTRelativeToEnd',
    'SpeechVoiceEvents', 'SP_VISEME_2', 'DISPID_SLGetWords',
    'SWTAdded', 'DISPID_SPRText', 'SpeechRecoEvents',
    'DISPID_SPARecoResult', 'DISPID_SABIBufferSize',
    'DISPID_SASetState', 'SP_VISEME_16', 'SpObjectToken',
    'SPEVENTSOURCEINFO', 'eLEXTYPE_RESERVED8',
    'IInternetSecurityMgrSite', 'DISPID_SRCERecognition',
    'DISPID_SPRuleNumberOfElements', 'SPWORDLIST',
    'eLEXTYPE_RESERVED6', 'SAFT24kHz16BitStereo',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet', 'ISpMMSysAudio',
    'SAFT32kHz8BitMono', 'SpeechDiscardType',
    'DISPID_SpeechRecoResult2', 'DISPID_SpeechPhraseInfo',
    'SPBO_TIME_UNITS', 'DISPID_SRCVoicePurgeEvent', 'SpLexicon',
    'DISPID_SGRsFindRule', 'SAFTCCITT_uLaw_11kHzStereo',
    'SPSERIALIZEDRESULT', 'DISPID_SpeechPhraseProperties', 'STCAll',
    'DISPID_SLRemovePronunciation', 'SPEI_WORD_BOUNDARY',
    'SRCS_Enabled', 'SPSSuppressWord', 'DISPID_SMSAMMHandle',
    'SPGS_ENABLED', '__MIDL_IWinTypes_0009', 'SpVoice',
    'DISPID_SRGId', 'SPSModifier', 'DISPID_SpeechRecoResultTimes',
    'eLEXTYPE_PRIVATE2', 'SPVPRI_OVER', 'SPRS_ACTIVE_USER_DELIMITED',
    'SAFT8kHz16BitMono', 'DISPID_SRGSetWordSequenceData',
    'DISPID_SVEBookmark', 'DISPID_SVEPhoneme', 'DISPID_SMSSetData',
    'SGPronounciation', 'SPEVENTENUM', 'DISPIDSPRG', 'SVP_6',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'DISPID_SRSSupportedLanguages',
    'DISPID_SVAlertBoundary', 'DISPID_SGRSRule',
    'IEnumSpObjectTokens', 'tagSPPROPERTYINFO',
    'SpTextSelectionInformation', 'SPAUDIOSTATE',
    'DISPID_SPRulesItem', 'DISPID_SPRuleEngineConfidence',
    'DISPID_SVEventInterests', 'SPAR_Medium', 'SPVPRIORITY',
    'DISPID_SRIsUISupported', 'STCInprocServer',
    'DISPID_SRGIsPronounceable', 'ISpeechGrammarRule', 'SVP_7',
    'SVP_16', 'DISPID_SRGDictationSetState', 'Speech_StreamPos_Asap',
    'SAFTCCITT_ALaw_22kHzStereo', 'SRSActiveAlways',
    'DISPID_SVSCurrentStreamNumber', 'DISPID_SGRSTNextState', 'SVP_9',
    'STCLocalServer', 'tagSTATSTG', 'STCRemoteServer',
    'ISpeechRecoResultTimes', 'SPEI_MAX_SR', 'SPGS_DISABLED',
    'ISpRecognizer3', 'SPSNoun', 'DISPID_SPPsCount',
    'DISPID_SGRSTText', 'SVP_20', 'eLEXTYPE_PRIVATE20',
    'DISPID_SRCPause', 'SVSFNLPMask', 'SAFTCCITT_ALaw_8kHzMono',
    'SVEWordBoundary', 'SGRSTTDictation', 'SpeechAudioFormatGUIDWave',
    'SP_VISEME_13', 'DISPID_SPPId', 'ISpeechLexicon',
    'DISPID_SpeechObjectTokenCategory', 'DISPID_SPIGetText',
    'eLEXTYPE_PRIVATE14', 'SPEI_VISEME', 'DISPID_SVVoice',
    'SVEEndInputStream', 'ISequentialStream', 'SPWT_LEXICAL',
    'SpPhraseInfoBuilder', 'DISPID_SpeechAudio', 'SPAUDIOSTATUS',
    'SpMMAudioIn', 'DISPID_SVEStreamStart', 'SVSFParseSsml',
    'SPEI_INTERFERENCE', 'DISPID_SRAudioInput',
    'SAFT22kHz16BitStereo', 'DISPID_SOTSetId', 'SPPS_NotOverriden',
    'ISpeechMMSysAudio', 'SPFM_OPEN_READWRITE',
    ...
    'DISPID_SPIAudioSizeTime', 'DISPID_SRCVoice', 'SDTReplacement',
    'DISPID_SLPLangId', 'SVEVoiceChange', 'SVF_None', 'SPPHRASE',
    'SSFMCreate', 'SP_VISEME_0', 'DISPID_SpeechObjectTokens',
    'SPSTREAMFORMATTYPE', 'SAFT32kHz8BitStereo',
    'DISPID_SPPEngineConfidence', 'SVPOver', 'DISPID_SLPsCount',
    'DISPID_SpeechObjectToken', 'DISPID_SLGenerationId',
    'ISpeechRecoResult', 'DISPID_SPIReplacements', 'SGDisplay',
    'SINoise', 'DISPID_SOTCSetId', 'SpMMAudioEnum',
    'SpSharedRecoContext', 'DISPID_SRProfile', 'SITooFast',
    'DISPID_SADefaultFormat', 'DISPID_SASCurrentSeekPosition',
    'Speech_Default_Weight', 'SPSUnknown', 'DISPID_SLWs_NewEnum',
    'DISPID_SRCreateRecoContext', 'SVEAudioLevel',
    'SpSharedRecognizer', 'SAFT11kHz16BitStereo', 'SSFMOpenForRead',
    'DISPID_SPILanguageId', 'SpeechPropertyResponseSpeed',
    'ISpeechPhraseRule', 'DISPID_SVSPhonemeId', 'SPPS_RESERVED3',
    'SVP_19', 'SPCT_DICTATION', 'SECFIgnoreCase',
    'DISPID_SpeechBaseStream', 'SpeechCategoryRecognizers',
    'ISpeechRecoContext', 'DISPID_SpeechMemoryStream',
    'DISPID_SRRSaveToMemory', 'DISPID_SpeechPhraseAlternates',
    'DISPID_SPAsCount', 'IInternetSecurityManager',
    'SAFTExtendedAudioFormat', 'ISpeechLexiconPronunciation',
    'ISpSerializeState', 'SpStream', 'SPEI_PHONEME',
    'SPSEMANTICERRORINFO', 'DISPID_SASFreeBufferSpace',
    'DISPID_SRCRecognizer', '_ISpeechVoiceEvents',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'ISpeechAudioFormat',
    'DISPID_SGRsCommitAndSave', 'SPEI_RECO_OTHER_CONTEXT',
    'SRADefaultToActive', 'DISPID_SpeechLexiconWords',
    'ISpGrammarBuilder', 'SGLexicalNoSpecialChars',
    'DISPID_SPRDisplayAttributes', 'SPBO_PAUSE',
    'SAFTCCITT_uLaw_8kHzStereo', 'SAFTCCITT_ALaw_44kHzStereo',
    'SDTPronunciation', 'DISPID_SOTDisplayUI', 'SPRECOSTATE',
    'SPSHORTCUTPAIR', 'ISpeechPhraseAlternate', 'ISpObjectToken',
    'SPPS_Verb', 'SECFNoSpecialChars', 'SpeechVoiceSkipTypeSentence',
    ...
    'DISPID_SRRGetXMLResult', 'SPPS_Interjection', 'IEnumString',
    'DISPID_SLAddPronunciationByPhoneIds', 'DISPID_SLPPartOfSpeech',
    'DISPID_SVEAudioLevel', 'DISPID_SLPsItem', 'SP_VISEME_15',
    'SP_VISEME_9', 'ISpeechAudio', 'DISPID_SREmulateRecognition',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SPFM_OPEN_READONLY',
    'SREPropertyStringChange', 'DISPID_SVSInputSentenceLength',
    'DISPID_SFSClose', 'SPAUDIOBUFFERINFO', 'SpeechRecognitionType',
    'SRESoundStart', 'DISPID_SpeechPhraseAlternate',
    'SAFTCCITT_uLaw_22kHzMono', 'DISPID_SRCEEnginePrivate',
    'SRTEmulated', 'DISPID_SPIProperties', 'DISPID_SDKSetBinaryValue',
    'SpUnCompressedLexicon', 'SPRST_NUM_STATES',
    'DISPID_SDKGetStringValue', 'SPEI_END_INPUT_STREAM', 'SGRSTTWord',
    'SPWF_SRENGINE', 'SAFT16kHz8BitStereo',
    'DISPID_SABufferNotifySize', 'SGDSInactive',
    'SPWORDPRONUNCIATIONLIST', 'SAFTADPCM_8kHzMono',
    'DISPID_SPPsItem', 'SpeechVisemeType',
    'DISPID_SpeechGrammarRuleStateTransitions', 'DISPID_SFSOpen',
    'SpeechRegistryLocalMachineRoot', 'DISPID_SLAddPronunciation',
    'SFTInput', 'SPPS_RESERVED4', 'SPINTERFERENCE_NOSIGNAL',
    'SPEI_VOICE_CHANGE', 'SPAR_Unknown', 'SRERequestUI',
    'DISPID_SGRsCount', 'SDTAudio', 'SP_VISEME_3',
    'eLEXTYPE_RESERVED9', 'SPSNotOverriden', 'SPVPRI_NORMAL',
    'SPINTERFERENCE_TOOSLOW', 'DISPID_SLWLangId',
    'SpeechPropertyResourceUsage', 'SP_VISEME_10', 'SpeechRuleState',
    'SAFTADPCM_22kHzMono', 'eLEXTYPE_PRIVATE1',
    'DISPID_SpeechLexiconWord', 'DISPID_SDKEnumValues',
    'eLEXTYPE_VENDORLEXICON', 'SRERecoOtherContext',
    'ISpPhoneticAlphabetSelection', 'SpeechPartOfSpeech',
    'SGSExclusive', 'DISPID_SRGReset', 'SLTUser', 'SPCS_ENABLED',
    'SPDATAKEYLOCATION', 'SPSEMANTICFORMAT', 'STSF_CommonAppData',
    'eLEXTYPE_PRIVATE13', 'SPDKL_CurrentUser',
    'DISPID_SPRuleFirstElement', 'ISpeechLexiconWords',
    'DISPID_SOTsCount', 'SPRULE', 'SAFTGSM610_44kHzMono',
    'SSFMCreateForWrite', 'SPWORDPRONUNCIATION', 'ISpeechFileStream',
    'ISpShortcut', 'DISPID_SRCEInterference', 'SAFT8kHz8BitMono',
    'SAFTADPCM_11kHzMono', 'SPAS_STOP',
    'DISPID_SVSyncronousSpeakTimeout', 'SpeechBookmarkOptions',
    'SpeechSpecialTransitionType', 'SAFTCCITT_uLaw_8kHzMono',
    'SPCONTEXTSTATE', 'SPSHT_NotOverriden',
    'DISPID_SRGCmdSetRuleState', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'DISPID_SpeechGrammarRule', 'SWPKnownWordPronounceable',
    'SVPAlert', 'SPGRAMMARSTATE', 'DISPID_SpeechPhraseRules',
    'SVP_12', 'DISPID_SAFType', 'SGDSActiveUserDelimited',
    'SP_VISEME_6', 'DISPID_SPIEngineId', 'SPSMF_SAPI_PROPERTIES',
    'SPEI_SR_PRIVATE', 'SPSFunction', 'SVSFVoiceMask',
    'SRCS_Disabled', 'DISPID_SVSpeakStream', 'ISpRecognizer',
    'DISPID_SRRPhraseInfo', 'DISPID_SGRSTsItem',
    'DISPID_SVSInputWordPosition', 'DISPID_SAEventHandle',
    'DISPID_SGRs_NewEnum', 'DISPID_SPCLangId',
    'ISpeechAudioBufferInfo', 'SpeechAudioFormatGUIDText',
    'DISPID_SRRRecoContext', 'SPCT_SUB_COMMAND',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'DISPID_SPPFirstElement',
    'SPSHT_Unknown', 'DISPID_SpeechPhraseElements', 'SPPS_Modifier',
    'DISPID_SPEEngineConfidence', 'DISPID_SOTId',
    'DISPID_SRAudioInputStream', 'DISPID_SPPConfidence',
    'SPWORDPRONOUNCEABLE', 'eLEXTYPE_RESERVED10', 'ISpNotifySource',
    'SVP_10', 'SVEStartInputStream', 'SAFT48kHz8BitStereo',
    'SGRSTTWildcard', 'SREBookmark', 'SPEI_MIN_SR',
    'DISPID_SPRuleParent', 'SPGRAMMARWORDTYPE', 'DISPID_SVResume',
    'SRAONone', 'DISPID_SGRSTPropertyName', 'SPEI_SOUND_END',
    'DISPID_SOTGetAttribute', 'STCInprocHandler', 'SVSFParseSapi',
    'DISPID_SRSNumberOfActiveRules', 'SAFT16kHz8BitMono',
    'SPEI_RESERVED3', 'DISPID_SPCPhoneToId', 'SAFT12kHz16BitStereo',
    'DISPID_SVSVisemeId', 'SpeechWordType', 'SpeechTokenValueCLSID',
    'SRAImport', 'SPPHRASEELEMENT', 'DISPID_SPRulesCount',
    'DISPID_SRSetPropertyNumber', 'SpeechEmulationCompareFlags',
    'SGLexical', 'SPPARTOFSPEECH', 'DISPID_SRRTTickCount',
    'SVSFDefault', 'SVP_1', 'DISPID_SRCState', 'DISPID_SpeechVoice',
    'SAFT11kHz8BitMono', 'ISpRecognizer2',
    'DISPID_SABIMinNotification', 'WAVEFORMATEX', 'SPPS_LMA',
    'DISPID_SRRDiscardResultInfo',
    'DISPID_SPPBRestorePhraseFromMemory', 'SAFT32kHz16BitMono',
    'DISPID_SPELexicalForm', 'SPEI_RESERVED5', 'SPSHT_EMAIL',
    'SAFTCCITT_ALaw_22kHzMono', 'SRSActive', 'DISPID_SGRSTsCount',
    'DISPID_SWFEExtraData', 'SWTDeleted', 'SECLowConfidence',
    'SpInProcRecoContext', 'DISPID_SDKSetLongValue',
    'DISPID_SGRAddResource', 'SAFTCCITT_ALaw_11kHzStereo',
    'ISpeechWaveFormatEx', 'DISPID_SRGetFormat', 'DISPID_SRRAudio',
    'SVSFParseAutodetect', 'DISPID_SpeechRecognizerStatus',
    'DISPID_SPEs_NewEnum', 'DISPID_SPPName',
    'DISPID_SVESentenceBoundary', 'DISPID_SDKCreateKey',
    'SPRECOCONTEXTSTATUS', 'DISPID_SpeechWaveFormatEx', 'SPAS_PAUSE',
    'DISPID_SpeechPhraseElement', 'DISPID_SPEDisplayAttributes',
    'SpeechEngineConfidence', 'DISPID_SpeechGrammarRules',
    ...
    'SPPS_Unknown', 'SPEI_TTS_AUDIO_LEVEL', 'DISPID_SGRSTransitions',
    'eLEXTYPE_PRIVATE8', 'ISpeechRecognizer', 'DISPID_SPAsItem',
    'DISPID_SPAPhraseInfo', 'DISPID_SRCESoundEnd', 'SREAudioLevel',
    'ISpeechDataKey', 'SAFT12kHz8BitMono', 'SpeechGrammarWordType',
    'eLEXTYPE_PRIVATE11', 'DISPID_SVPriority', 'SGSDisabled',
    'SGRSTTEpsilon', 'ISpProperties', 'DISPID_SpeechMMSysAudio',
    'DISPIDSPTSI', 'SpFileStream', 'SAFT22kHz8BitMono',
    'SPEI_FALSE_RECOGNITION', 'DISPID_SVRate',
    'DISPID_SPEAudioSizeBytes', 'SpeechTokenKeyUI',
    'SPEI_RECO_STATE_CHANGE', 'DISPID_SPACommit', 'DISPID_SGRSTType',
    'SPRS_ACTIVE', 'SPEI_START_SR_STREAM', '_SPAUDIOSTATE',
    'DISPID_SVSpeakCompleteEvent', 'SP_VISEME_11',
    'DISPID_SPIGrammarId', 'STSF_LocalAppData',
    'ISpeechResourceLoader', 'DISPID_SPIElements',
    'ISpeechGrammarRuleStateTransitions', 'eLEXTYPE_USER_SHORTCUT',
    'SAFTCCITT_uLaw_44kHzMono',
    'DISPID_SLRemovePronunciationByPhoneIds',
    'SpeechCategoryAppLexicons', 'eLEXTYPE_PRIVATE12', 'SPSMF_UPS',
    'DISPID_SVSLastStreamNumberQueued', 'DISPID_SRStatus',
    'DISPID_SVAudioOutputStream', 'SpPhoneticAlphabetConverter',
    'ISpeechPhraseInfoBuilder', 'SPBOOKMARKOPTIONS',
    'DISPID_SRRTLength', 'DISPID_SPERetainedStreamOffset',
    'SPVPRI_ALERT', 'SVP_3', 'ISpeechPhraseReplacement',
    'SVSFIsNotXML', 'DISPID_SPRFirstElement', 'SpeechVoicePriority',
    'SAFTText', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SRTStandard',
    'SPFM_CREATE_ALWAYS', 'DISPID_SWFEFormatTag',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SPRST_INACTIVE',
    'ISpAudio', 'eLEXTYPE_PRIVATE19', 'Speech_StreamPos_RealTime',
    'eLEXTYPE_RESERVED4', 'SITooSlow', 'SPEI_ADAPTATION',
    'SREPrivate', 'DISPID_SGRClear', 'ISpeechObjectTokens',
    'SVSFParseMask', 'SREAllEvents', 'DISPID_SVEVoiceChange',
    'DISPID_SAVolume', 'SPRULESTATE', 'DISPID_SRCEAudioLevel',
    'DISPID_SpeechVoiceStatus', 'SDTProperty', 'ISpeechXMLRecoResult',
    'DISPID_SABufferInfo', 'DISPID_SPIRule', 'SpeechRunState',
    'SDTRule', 'SpeechFormatType', 'SpMMAudioOut', 'SREHypothesis',
    'SREPropertyNumChange', 'SSTTDictation', 'SP_VISEME_19',
    'SPLOADOPTIONS', 'DISPID_SVSLastBookmark', 'SREStreamStart',
    'DISPIDSPTSI_SelectionOffset', 'SRADynamic', 'ISpeechPhraseInfo',
    'DISPID_SPEsCount', 'DISPID_SPRuleConfidence', 'ISpRecoResult',
    'SAFT22kHz8BitStereo', 'SDA_Consume_Leading_Spaces',
    'SECFDefault', 'ISpeechBaseStream', 'DISPID_SBSWrite',
    'DISPID_SDKSetStringValue', 'DISPID_SRCEHypothesis',
    'SP_VISEME_12', 'SpeechTokenIdUserLexicon',
    'DISPID_SpeechPhraseReplacements', 'DISPID_SpeechVoiceEvent',
    'DISPID_SRCAudioInInterferenceStatus', 'DISPID_SpeechLexicon',
    'SP_VISEME_18', 'ISpObjectWithToken', 'DISPID_SpeechRecoResult',
    'SpeechMicTraining', 'SPEI_HYPOTHESIS', 'SRATopLevel',
    'SpeechGrammarTagUnlimitedDictation', 'DISPID_SVSLastResult',
    'SSSPTRelativeToCurrentPosition', 'SAFTADPCM_22kHzStereo',
    'DISPID_SRCERequestUI', 'SpeechAudioVolume',
    'SVESentenceBoundary', 'SPLEXICONTYPE', 'SAFT48kHz16BitStereo',
    'SVP_4', 'SpeechUserTraining', 'SPINTERFERENCE_TOOQUIET',
    'SGSEnabled', 'DISPID_SGRAddState', 'DISPID_SOTCEnumerateTokens',
    'DISPID_SpeechAudioStatus', 'DISPID_SVSpeak', 'SPCATEGORYTYPE',
    'SPRST_INACTIVE_WITH_PURGE', 'SAFT12kHz8BitStereo',
    'DISPID_SPPValue', 'DISPID_SpeechDataKey',
    'SWPUnknownWordUnpronounceable', 'SpNotifyTranslator',
    'DISPID_SDKDeleteKey', 'DISPID_SDKEnumKeys', 'SVP_21',
    'SpeechRegistryUserRoot', 'SPWT_DISPLAY', 'SpAudioFormat',
    'DISPID_SOTGetStorageFileName', 'DISPID_SOTRemoveStorageFileName',
    'DISPID_SRSetPropertyString', 'SVEPrivate', 'ISpeechRecoGrammar',
    'SASPause', 'DISPID_SGRSTPropertyId', 'DISPID_SVEWord',
    'DISPID_SLPType', 'SpeechRuleAttributes', 'ISpRecoCategory',
    'SpeechDisplayAttributes', 'DISPID_SPRuleName', 'SVP_0',
    'DISPID_SpeechFileStream', 'DISPID_SRGCommit', 'SVSFUnusedFlags',
    'DISPID_SASState', 'SREStreamEnd', 'SVP_13', 'SRAORetainAudio',
    'SAFT48kHz16BitMono', 'ISpNotifyTranslator',
    'ISpStreamFormatConverter', 'DISPID_SPEAudioTimeOffset',
    'SP_VISEME_21', 'DISPID_SVVolume', 'DISPID_SVEViseme',
    'DISPID_SAFGetWaveFormatEx', 'SRSInactive', 'DISPID_SOTDataKey',
    'DISPID_SVDisplayUI', 'SP_VISEME_7', 'SPEI_RESERVED6', 'SVP_15',
    'SpeechDictationTopicSpelling', 'SPPHRASEPROPERTY',
    'SPPHRASERULE', 'SRESoundEnd', 'SRAInterpreter',
    'SPINTERFERENCE_NOISE', 'DISPID_SDKOpenKey', 'DISPID_SVSkip',
    'SPEI_TTS_PRIVATE', 'SPRST_ACTIVE', 'DISPID_SRRecognizer',
    'DISPID_SRRAlternates', 'SAFTGSM610_8kHzMono',
    'DISPID_SCSBaseStream', 'DISPID_SGRsAdd', 'DISPID_SPEDisplayText',
    'DISPID_SPRules_NewEnum', 'SpeechGrammarState',
    'DISPID_SGRSTs_NewEnum', 'SPEI_RESERVED1',
    'DISPIDSPTSI_ActiveOffset', 'SPEVENT', 'DISPID_SGRSTRule',
    'ISpeechGrammarRuleState', 'SPFM_CREATE', 'SPBO_AHEAD',
    'DISPID_SVSInputWordLength', 'SDA_Two_Trailing_Spaces',
    'SDTAlternates', 'eLEXTYPE_PRIVATE16', 'eLEXTYPE_PRIVATE15',
    'ISpeechRecognizerStatus', 'ISpeechPhraseProperty', 'SPAS_RUN',
    'SAFT44kHz8BitStereo', 'SVSFIsXML', 'DISPID_SPPChildren',
    'DISPID_SPISaveToMemory', 'SPEI_PROPERTY_NUM_CHANGE',
    'SAFTCCITT_ALaw_11kHzMono', 'SP_VISEME_20', 'DISPID_SGRName',
    'DISPID_SGRAttributes', 'SVP_17', 'SPCS_DISABLED', 'SRTReSent',
    'ISpeechObjectToken', 'DISPID_SLWType', 'SPSInterjection',
    'eLEXTYPE_PRIVATE17', 'DISPID_SGRSTPropertyValue',
    'eLEXTYPE_LETTERTOSOUND', 'DISPID_SGRSAddRuleTransition',
    'DISPID_SMSALineId', 'SPEI_SR_BOOKMARK', 'SAFT16kHz16BitStereo',
    'SpeechGrammarTagDictation', 'SPRECORESULTTIMES', 'SDTAll',
    'SPSHORTCUTPAIRLIST', 'DISPID_SRSAudioStatus', 'DISPID_SPEsItem',
    'SPLO_STATIC', 'DISPID_SAFSetWaveFormatEx',
    'SpeechPropertyComplexResponseSpeed', 'DISPID_SVStatus',
    'DISPID_SLWPronunciations',
    'SpeechPropertyNormalConfidenceThreshold', 'DISPID_SPPParent',
    'SPEI_SENTENCE_BOUNDARY', 'SECFEmulateResult', 'DISPID_SAStatus',
    'SAFT24kHz16BitMono', 'SAFT8kHz8BitStereo', 'DISPID_SRCResume',
    'DISPID_SVAudioOutput', 'SpeechPropertyAdaptationOn',
    'DISPID_SPRuleId', 'SDA_No_Trailing_Space', 'SGDSActive',
    'SPINTERFERENCE_LATENCY_WARNING', 'SPAUDIOOPTIONS', 'ISpVoice',
    'ISpRecoGrammar', 'DISPID_SLWsCount', 'SPSHT_OTHER',
    'SVF_Stressed', 'DISPID_SDKGetlongValue', 'DISPID_SOTsItem',
    'SpeechStreamSeekPositionType', 'SPPS_RESERVED2',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'SpeechVoiceSpeakFlags', 'DISPID_SRRAudioFormat',
    'SVSFNLPSpeakPunc', 'DISPID_SLWsItem', 'eLEXTYPE_PRIVATE9',
    'DISPID_SRGCmdLoadFromFile', 'DISPID_SRRTimes',
    'SAFTCCITT_uLaw_44kHzStereo', 'SPBINARYGRAMMAR',
    'DISPID_SPIAudioStreamPosition', 'STSF_FlagCreate',
    'SpeechAudioState', 'DISPID_SPIAudioSizeBytes',
    'SAFTCCITT_ALaw_8kHzStereo', 'SECHighConfidence', 'SRAExport',
    'ISpRecoGrammar2', 'eLEXTYPE_APP', 'ISpPhoneConverter',
    'LONG_PTR', 'DISPID_SPRsCount', 'SRARoot',
    'DISPID_SPPNumberOfElements', 'SLOStatic', 'ISpeechLexiconWord',
    'SPAR_High', 'SPAO_NONE', 'SASClosed', 'SAFTCCITT_ALaw_44kHzMono',
    'ISpNotifySink', 'SSTTTextBuffer',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SRCEStartStream', 'SpShortcut', 'SVSFlagsAsync',
    'DISPID_SPEPronunciation', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'SPDKL_LocalMachine', 'DISPID_SOTCreateInstance',
    'DISPID_SOTs_NewEnum', 'DISPID_SAFGuid', 'SAFTDefault',
    ...
    'ISpStreamFormat', 'DISPID_SpeechXMLRecoResult',
    'DISPID_SRRTStreamTime', 'ISpeechPhraseElements',
    'DISPID_SVEEnginePrivate', 'DISPID_SPRs_NewEnum',
    'DISPID_SPIGetDisplayAttributes', 'ISpXMLRecoResult',
    'DISPID_SRCERecognitionForOtherContext', 'SRTExtendableParse',
    'SASRun', 'DISPID_SPIRetainedSizeBytes',
    'DISPID_SOTGetDescription', 'SpeechAudioFormatType',
    'SPCT_COMMAND', 'SVP_14', 'SpeechCategoryAudioOut',
    'SpeechRecoProfileProperties', 'DISPID_SRRSpeakAudio',
    'DISPID_SpeechPhraseProperty', 'SPLO_DYNAMIC',
    'SpInprocRecognizer', 'SRTAutopause', 'DISPID_SOTCategory',
    'DISPID_SMSGetData', 'DISPID_SLGetPronunciations',
    'DISPID_SPEAudioSizeTime', 'SVSFIsFilename',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'ISpeechLexiconPronunciations',
    'SPPS_SuppressWord', 'SAFTTrueSpeech_8kHz1BitMono',
    'SGDSActiveWithAutoPause', 'eLEXTYPE_PRIVATE7',
    'DISPID_SPIEnginePrivateData', 'eLEXTYPE_PRIVATE5',
    'STSF_AppData', 'SPWT_PRONUNCIATION', 'SPEI_UNDEFINED', 'SPSVerb',
    'DISPID_SGRsItem', 'DISPID_SRCEPropertyStringChange',
    'DISPID_SRRSetTextFeedback', 'DISPID_SGRSTWeight',
    'ISpRecoContext', 'DISPID_SBSRead', 'SSTTWildcard',
    'SAFT11kHz8BitStereo', 'SpStreamFormatConverter',
    'SpeechVisemeFeature', 'SVP_2', 'DISPID_SPAs_NewEnum',
    'DISPID_SWFEChannels', 'SPEI_MIN_TTS', 'SPEI_SOUND_START',
    'SPEI_PHRASE_START', 'SGRSTTRule', 'DISPID_SRCRequestedUIType',
    'SAFTADPCM_11kHzStereo', 'SAFT44kHz16BitMono', 'SVPNormal',
    'SpeechInterference', 'SPRST_ACTIVE_ALWAYS',
    'Speech_Max_Word_Length', 'SpeechPropertyHighConfidenceThreshold',
    'DISPID_SVEStreamEnd', 'SREFalseRecognition', 'SPEI_MAX_TTS',
    'DISPID_SVIsUISupported', 'DISPID_SPRsItem', 'eLEXTYPE_PRIVATE3',
    'DISPID_SRCSetAdaptationData', 'SRSEIsSpeaking', 'ISpStream',
    'SPSLMA', 'SAFT48kHz8BitMono', 'SAFTADPCM_44kHzStereo',
    'SPDKL_CurrentConfig', 'DISPID_SpeechPhraseBuilder',
    'ISpeechRecoResultDispatch', 'SPPS_Noun', 'SpMemoryStream',
    'ISpPhrase', 'DISPID_SRCEEndStream', 'DISPID_SOTRemove',
    'DISPID_SRIsShared', 'IStream', 'SECFIgnoreKanaType', 'SITooLoud',
    'SREInterference', 'ISpEventSink', 'SPVISEMES',
    'SPINTERFERENCE_NONE', 'SpeechCategoryRecoProfiles',
    'SPEI_RECOGNITION', 'ISpeechPhraseElement',
    'DISPID_SPEAudioStreamOffset', 'DISPID_SRCCreateResultFromMemory',
    'DISPID_SpeechAudioFormat', 'DISPID_SGRId', 'DISPID_SRGRules',
    'SVP_11', 'eWORDTYPE_ADDED', 'DISPID_SWFESamplesPerSec',
    'SFTSREngine', 'SpeechRecoContextState', 'ISpeechCustomStream',
    'SPAR_Low', 'DISPID_SDKDeleteValue', 'DISPID_SpeechLexiconProns',
    'DISPID_SASNonBlockingIO', 'DISPID_SVSLastBookmarkId',
    'DISPID_SRGState', 'SPCT_SLEEP',
    'DISPID_SRSCurrentStreamPosition', 'SPXRO_Alternates_SML',
    'SSSPTRelativeToStart', 'DISPID_SpeechLexiconPronunciation',
    'DISPID_SpeechPhoneConverter', 'SREPhraseStart',
    'DISPID_SRGetPropertyNumber', 'eWORDTYPE_DELETED',
    'DISPID_SRGSetTextSelection', 'DISPID_SVPause', 'SPINTERFERENCE',
    'SBONone', 'DISPID_SpeechRecognizer', 'SpeechCategoryAudioIn',
    'DISPID_SRCERecognizerStateChange', 'SPEI_START_INPUT_STREAM',
    'eLEXTYPE_PRIVATE18', 'SVSFPersistXML', 'SINone',
    'SPEI_RESERVED2', 'SVP_8', 'DISPID_SPRuleChildren',
    'DISPID_SPCIdToPhone', 'SREAdaptation', 'DISPID_SPIStartTime',
    'ISpeechVoiceStatus', 'SVP_18', 'eLEXTYPE_USER',
    'DISPID_SRGCmdLoadFromMemory', 'SPINTERFERENCE_TOOLOUD',
    'SRTSMLTimeout', 'eLEXTYPE_PRIVATE6', 'SpCompressedLexicon',
    'DISPID_SPERetainedSizeBytes', 'SPBO_NONE',
    'DISPID_SPEActualConfidence', 'SpeechVoiceCategoryTTSRate',
    'DISPID_SRSClsidEngine', 'SVP_5', 'DISPID_SWFEBlockAlign',
    'SpCustomStream', 'SPEI_PROPERTY_STRING_CHANGE',
    'SSFMOpenReadWrite', 'SPADAPTATIONRELEVANCE',
    'SAFT16kHz16BitMono', 'DISPID_SRGCmdLoadFromResource',
    'SDTLexicalForm', 'SAFT44kHz16BitStereo',
    'SpeechCategoryPhoneConverters',
    'DISPID_SPANumberOfElementsInResult', 'SASStop', 'UINT_PTR',
    'SRSInactiveWithPurge', 'DISPID_SRCEPropertyNumberChange',
    'ISpLexicon', 'SPSMF_SRGS_SAPIPROPERTIES', 'SAFT32kHz16BitStereo',
    'SPXMLRESULTOPTIONS', 'SpeechWordPronounceable',
    'SpResourceManager', 'SpeechLoadOption',
    'ISpeechPhraseAlternates', 'DISPID_SRGetRecognizers',
    'SpeechDataKeyLocation', 'SITooQuiet',
    'DISPID_SRCRetainedAudioFormat', 'DISPID_SGRInitialState',
    'DISPID_SVGetVoices', 'DISPID_SGRsCommit', 'SLODynamic',
    'ISpeechGrammarRules',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'SPWORD',
    'SPFM_NUM_MODES', 'DISPID_SOTCDefault', 'eLEXTYPE_PRIVATE4',
    'DISPID_SASCurrentDevicePosition', 'ISpeechRecoResult2',
    'SPFILEMODE', 'SP_VISEME_8', 'DISPID_SRCEBookmark',
    'SVEAllEvents', 'DISPID_SVGetAudioInputs',
    'DISPID_SWFEBitsPerSample', 'SP_VISEME_1', 'SP_VISEME_14',
    'SpeechStreamFileMode', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'SpObjectTokenCategory', 'DISPID_SGRsDynamic',
    'DISPID_SWFEAvgBytesPerSec', 'ISpeechAudioStatus',
    'SPEI_END_SR_STREAM', 'SpeechAllElements', 'SpeechTokenKeyFiles',
    'DISPID_SpeechRecoContext', 'Speech_Max_Pron_Length',
    'SPSERIALIZEDPHRASE', 'SAFTNonStandardFormat',
    'SPAO_RETAIN_AUDIO', 'DISPID_SBSSeek', 'SPRECOGNIZERSTATUS',
    'ISpResourceManager', 'SPWF_INPUT', 'SDKLCurrentConfig',
    'DISPID_SRCEPhraseStart', 'DISPID_SRGCmdSetRuleIdState',
    'SPEI_TTS_BOOKMARK', 'SAFTGSM610_22kHzMono', 'SpeechLexiconType',
    'SP_VISEME_5', 'SPWORDTYPE', 'SVEPhoneme', 'DISPID_SOTCId',
    'DISPID_SVGetProfiles', 'SPEI_SR_AUDIO_LEVEL',
    'SAFT11kHz16BitMono', 'SAFTGSM610_11kHzMono', 'SpWaveFormatEx',
    'DISPID_SVSInputSentencePosition', 'DISPID_SpeechAudioBufferInfo',
    'DISPID_SRGDictationLoad', 'SpeechRecognizerState',
    'DISPID_SRSCurrentStreamNumber', 'DISPID_SDKGetBinaryValue',
    'DISPID_SMSADeviceId', 'SPDKL_DefaultLocation',
    'ISpeechMemoryStream', 'SPVOICESTATUS', 'SpPhoneConverter',
    'SPPROPERTYINFO', 'SPPS_RESERVED1', 'SP_VISEME_4',
    'DISPID_SpeechPhraseRule', 'ISpEventSource', 'SPSHORTCUTTYPE',
    'SPGS_EXCLUSIVE', 'SpeechTokenContext', 'DISPID_SABIEventBias',
    'SpeechRetainedAudioOptions', 'SPPS_Function',
    'DISPID_SLGetGenerationChange', 'SINoSignal',
    'ISpeechGrammarRuleStateTransition', 'DISPID_SRDisplayUI',
    'SDKLLocalMachine', 'DISPIDSPTSI_ActiveLength', 'SRERecognition',
    'DISPID_SRRTOffsetFromStart',
    'SpeechGrammarRuleStateTransitionType', 'SLTApp',
    'SPPHRASEREPLACEMENT', 'SAFTADPCM_44kHzMono',
    'DISPID_SGRSAddSpecialTransition', 'SECNormalConfidence',
    'SBOPause', 'SAFTNoAssignedFormat',
    'DISPID_SpeechPhraseReplacement', 'SDKLCurrentUser',
    '_RemotableHandle', 'SAFT44kHz8BitMono', 'SDKLDefaultLocation',
    'SP_VISEME_17', 'ISpeechTextSelectionInformation',
    'DISPID_SRCCmdMaxAlternates', 'DISPID_SLWWord',
    'DISPID_SRGRecoContext', 'ISpeechPhraseProperties',
    'SpeechPropertyLowConfidenceThreshold',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'DISPID_SLPSymbolic',
    'SpeechGrammarTagWildcard', 'SVEViseme',
    'DISPID_SRRGetXMLErrorInfo', 'ISpeechPhraseReplacements',
    'DISPIDSPTSI_SelectionLength', 'DISPID_SPAStartElementInResult'
]

_check_version('1.1.14', 1657895856.257913)
